%   Cubic B-Spline Trajectory Planner Class(only position):
%   A specific class that plans and generates cubic B-spline for 2d/3d position trajectory
...
classdef BSplinePosPlanner < handle
    properties
        nump
        num_ctrlp
        pdegree
    ...
    methods
        ...
        function obj = BSplinePosPlanner(via_pos, option, uk)
