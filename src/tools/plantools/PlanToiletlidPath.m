...
%   close -> PlanToiletlidPath(vision_pos,-60degree,-30degree,-90degree,0.03)
%   left config:
%   open -> PlanToiletlidPath(vision_pos,110degree,-(90+10)degree,0degree,0.03)
...
if abs(posC(2)-posB(2))<abs(posC(2)-posA(2))
    mark_sign = 1;
else
    mark_sign = -1;
end
