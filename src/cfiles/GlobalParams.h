...
const double g_stowed_jpos[] = { 0,0,0,0,0 };
const double g_stowed_cpos[] = { 0,0.7,0.6 };
const double g_return_err[] = { 0.001, 0.001, 0.001, 0.001, 0.001 };
const double g_jvmax[] = {pi, 0.15, 0.8*pi, 0.5, 0.8*pi};
const double g_jamax[] = { 2*pi, 0.3, 1.6*pi, 1, 1.6*pi };
const double g_cvmax = 0.4;
const double g_camax = 0.8;
